...
> generating, or refactoring React codebases. Humans may also find it
...
5. [Re-render Optimization](#5-re-render-optimization) — **MEDIUM**
   ...
   - 5.7 [Avoid Unnecessary useEffect](#57)
...
### 5.7 Avoid Unnecessary useEffect
...
**Don't use for transforming data:**
...
**Don't use for expensive calculations (use useMemo):**
...
**Don't use for handling user events:**

```tsx
// Incorrect: Effect responds to state change
...
**Don't use to reset state on prop change (use key):**
...
// Correct: use key to reset entire component
